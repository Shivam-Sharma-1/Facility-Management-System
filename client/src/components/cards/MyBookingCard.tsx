...
const MyBookingCard: FC<MyBookingCardProps> = ({
  ...
  return (
    <Slide direction="up" in={true} mountOnEnter unmountOnExit>
      <div
        className={`justify-between items-center px-10 py-8 xl:w-[70%] w-full h-full flex mt-6 rounded-md bg-bgPrimary shadow-cardHover border-0 border-l-[10px] border-solid ${
          status === "PENDING" ||
